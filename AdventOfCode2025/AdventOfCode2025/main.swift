...
func performDay(_ xcodePath: URL) throws {
...
func determineWorkingDirectory() -> URL {
    print("Please provide directory of advent-of-code-2025 repository:")
    let workingDirectoryURL = URL(fileURLWithPath: readLine(strippingNewline: true) ?? "~")
    let xcodePath = URL(string: "\(workingDirectoryURL)/AdventOfCode2025/AdventOfCode2025")!
    return xcodePath
}
